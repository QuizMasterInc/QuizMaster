    ...
    <div className="space-y-8">
      ...
      <div className="bg-card rounded-2xl p-6 shadow-xl border border-accent">
        ...
        <div className="flex gap-4 mt-8">
          ...
          <button
            onClick={sendQuiz}
            className="flex-1 px-6 py-3 bg-green-600 hover:bg-green-700 text-white rounded-lg font-medium transition-all duration-200 shadow-md hover:shadow-lg border border-green-600"
          >
            Finish Quiz
          </button>
        </div>
